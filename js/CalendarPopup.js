...
function setCalendarControlDate(year, month, day) {
	...
	$('.bas_review_date').data('date', year+'-'+month+'-'+day);
	if (typeof(bas_review_date_change) == 'function') {
		bas_review_date_change();
	}
	if (typeof(bas_report_date_change) == 'function') {
		bas_report_date_change();
	}
}
